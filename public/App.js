        ...
        <div className='additional-info'>
          ...
          <div className='options'>
            ...
            <div className='section-title people-quantity-div'>
              Number of people
              <input type='number' min='0' className='people-quantity-input'></input>
            </div>
            ...
            <div>
              ...
              <div className='ui checkbox breaks-options'>
                <input type='checkbox' className='options-button-input'></input>
                <label className='options-checkbox'>Carrying other heavy things</label>
              </div>
              <div></div>
            </div>
          </div>
          ...
          <div className='packages-wrapper'>
            <div className='packages-item'>
              ...
              <div className='package-item-right'>
                <div className='packages-button'>Information and Purchasing</div>
